...
def test_reconcile_decoded_windows_drops_aligned_overlap_duplicates() -> None:
...
def test_reconcile_decoded_windows_prefers_center_of_overlap() -> None:
    transcription, stats = reconcile_decoded_windows([
        DecodedWindow(
            window=InferenceWindow(
                window_id="window-1",
...
def test_reconcile_decoded_windows_keeps_monotonic_segment_boundaries() -> None:
