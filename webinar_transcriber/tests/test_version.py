...
def test_resolve_version_uses_generated_version_file(monkeypatch) -> None:
    monkeypatch.setattr(
        webinar_transcriber,
        "import_module",
...
def test_resolve_version_falls_back_without_generated_version_file(monkeypatch) -> None:
